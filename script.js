...
// this function creates option el depending on the subjects value
createOptionElements(selectSubject, subjects);

subjectYearInputForm.addEventListener("submit", function (event) {
  event.preventDefault();

  const homePageInputObj = {
    name: selectSubject.value,
    year: selectYear.value,
  };

  // this filterData function filters courseData based on homePageInputObj
  filterData(homePageInputObj);
